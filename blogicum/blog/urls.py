...
urlpatterns = [
    ...
    path('posts/create_post/', views.PostCreateView.as_view(), name='create_post'),
    ...
    path('posts/<int:post_pk>/edit_comment/<int:comment_pk>/', views.CommentUpdateView.as_view(), name='edit_comment'),
    path('posts/<int:post_pk>/delete_comment/<int:comment_pk>/', views.CommentDeleteView.as_view(), name='delete_comment'),
]
